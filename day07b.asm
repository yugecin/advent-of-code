...
aoc:
	...
	; part2: fuel cost is not linear, precalc it in fuel_cost for each step
	xor ecx, ecx
	xor eax, eax
@@nextfuelcost:
	add eax, ecx
	mov dword [fuel_cost+ecx*4], eax
	inc ecx
	cmp ecx, 2000
	jl @@nextfuelcost
...
@@addnextfuel:
	...
	; abs done
	; part 2: but fuel costs are not linear, oh no!
	mov edi, dword [fuel_cost+edi*4]
...
section .bss
	fuel_cost resd 2000 ; I feel like input is 0-1999
