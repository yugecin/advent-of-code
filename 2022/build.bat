...
CALL :RUN day02-faster-a.asm %1 || GOTO:ERR
CALL :RUN day02-faster-b.asm %1 || GOTO:ERR
CALL :RUN day03a.asm %1 || GOTO:ERR
CALL :RUN day03b.asm %1 || GOTO:ERR
CALL :RUN day04a.asm %1 || GOTO:ERR
CALL :RUN day04b.asm %1 || GOTO:ERR
CALL :RUN day04b-xmm.asm %1 || GOTO:ERR
CALL :RUN day05a.asm %1 || GOTO:ERR
CALL :RUN day05b.asm %1 || GOTO:ERR
CALL :RUN day05-preparsed-a.asm %1 || GOTO:ERR
CALL :RUN day05-preparsed-b.asm %1 || GOTO:ERR
...
CALL :RUN day09a.asm %1 || GOTO:ERR
CALL :RUN day10a.asm %1 || GOTO:ERR
CALL :RUN day10b.asm %1 || GOTO:ERR
CALL :RUN day11a.asm %1 || GOTO:ERR
GOTO:EOF
