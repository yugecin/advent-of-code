...
aoc2024.exe is built with:
gcc -Wall -fno-strict-aliasing -x c aoc2024.c -o aoc2024.exe

run "build.bat" and it compiles and spouts all solutions

run "build.bat /DEBUG" to make aoc2024.exe wait before running each solution,
this is useful to attach a debugger to the waiting process to debug the dll.

run "build.bat /BENCH" to make aoc2024.exe run the solutions multiple times,
